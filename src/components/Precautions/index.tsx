        ...
        <div className="text-[13px] text-[#444444] tracking-[0.06em] leading-[1.65] font-zen-kaku-gothic space-y-4 max-h-[300px] overflow-y-auto pr-4">
          <section>
            ...
            <p>
              ...
              <br />
              （如何なる理由でも、キャンセル期限を過ぎますとキャンセル料100％がかかります。あらかじめご了承くださいませ。）
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <br />
              ・ご予約確定後の人数変更は出来かねます。一度キャンセルし、再予約をお願いします。
              <br />
              ・予約開始時間48時間前を過ぎると、それ以降の予約内容（人数変更など）の変更はご対応出来かねます。
              <br />
              ※人数追加の場合のみ、現地で追加精算頂く形でご対応が可能です。
              <br />
              ・予約キャンセルをされた場合、「【予約キャンセル】ご予約のキャンセルを承りました。」というメールが届いたら予約キャンセル確定となります。
              <br />
