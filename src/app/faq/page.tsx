          ...
          <div className="space-y-4">
            {faqItems.map((item) => (
              <div key={item.id} className="space-y-2">
                <div
                  className="border border-[#BBBBBB] rounded-[4px] px-4 py-3 cursor-pointer"
                  onClick={() => toggleItem(item.id)}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <span className="text-[16px] font-medium text-[#C78C51] tracking-[0.06em] font-zen-kaku-gothic">
                        Q.
                      </span>
                      <span className="text-[16px] font-medium text-[#444444] tracking-[0.06em] font-zen-kaku-gothic">
                        {item.question}
                      </span>
                    </div>
                    <span className="text-[20px] font-medium text-[#444444]">
