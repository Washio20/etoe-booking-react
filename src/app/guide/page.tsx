...
・アンケートにご回答いただいた方には、次回ご利用時に使える特典をご用意しております。`,
  ...
  return (
    <Layout>
      <div className="max-w-[920px] mx-auto p-4 md:p-8">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="space-y-6">
            {steps.map((step, index) => (
              <div
                key={index}
                className="border border-[#BBBBBB] rounded-[4px] bg-white flex overflow-hidden"
              >
                <div className="hidden sm:flex w-[220px] justify-center items-center p-4">
                ...
                <div className="flex-grow py-4 px-4 md:px-8 space-y-2">
                  <div className="flex flex-col gap-1">
                    <span className="text-[13px] text-[#C78C51] tracking-[0.06em] font-zen-kaku-gothic font-bold inline-block">
                      Step.{step.number}
                    </span>
                    <div className="h-[1px] bg-[#C78C51] w-[45px]" />
                  </div>
                  <h2 className="text-[16px] font-medium text-[#444444] tracking-[0.06em] font-zen-kaku-gothic mt-2">
                    {step.title}
                  </h2>
                  <p className="text-[13px] text-[#444444] tracking-[0.06em] leading-[1.65] font-zen-kaku-gothic whitespace-pre-line">
                    {step.description}
                  </p>
                </div>
              </div>
